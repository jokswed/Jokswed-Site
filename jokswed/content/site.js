...
export const tarifs = {
  ...
  options: [
    ...
    { nom: "Vidéaste professionnel", detail: "Je m’appelle Yvann , réalisateur, monteur et vidéaste. Je crée des films de mariage de 3 à 5 minutes, pour immortaliser votre journée avec une approche élégante, authentique et riche en émotions. En complément, je propose une vidéo Focus Mariés : un court film entièrement dédié à votre couple, mettant en lumière votre complicité, vos regards, votre amour et les émotions qui vous unissent, dans une approche cinématographique. Chaque création est pensée comme un souvenir intemporel que vous aurez plaisir à revivre et à partager." },
